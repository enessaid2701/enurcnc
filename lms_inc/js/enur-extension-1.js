...
/*---====================---preloader---======================---*/
function enur_preloader() {
	if($('.preloader-wrap').length){
		$('.preloader-wrap').delay(500).fadeOut(100);
	}
}
/*---====================---progress bar---======================---*/
$.fn.enurProgressbar = function(options){
    options = $.extend({
      animate     : true,
      animateText : true
    }, options);
...
$(document).ready(function(){
  $('.ProgressBar--animateNone').enurProgressbar({
    animate : false,
    animateText : false
  });
  $('.ProgressBar--animateCircle').enurProgressbar({
    animate : true,
    animateText : false
  });
  $('.ProgressBar--animateText').enurProgressbar({
    animate : false,
    animateText : true
  });
  $('.ProgressBar--animateAll').enurProgressbar();
});
/*---====================---header js ---======================---*/
...
/*---====================---enur_grid_layout_main---======================---*/
function enur_grid_layout_main() {
...
/*---====================---theme carousel---======================---*/
function enur_theme_owl_carousel() {
...
/*---====================---grid layout---======================---*/
function enur_grid_filter_layout() {
...
/*---====================---showcase tab---======================---*/
function enur_countdown_timer() {
    if ($('.countdown').length) {
        $(".countdown").countdown();
    }
}
/*---====================---light box---======================---*/ 
function enur_sidemenu() {
...
/*---====================---floating menu---======================---*/ 
function enur_floating_menu_enable() {
...
jQuery(window).on('load', function() {
    (function($) {
        enur_grid_layout_main();
        enur_search_popup();
        enur_swiper_with_tab();
        enur_funfacts_one();
        enur_grid_filter_layout();
        enur_accordion();
        enur_light_box();
        enur_modal_popup ();
        enur_tabone();
        enur_tab_content();
        enur_theme_owl_carousel();
        enur_countdown_timer();
        enur_faqsall();
        enur_progress_bar();
        enur_sidemenu();
        enur_floating_menu_enable();
        enur_floating_menu();
        enur_projectfilter();
        enur_preloader();
        enur_swiper_options();

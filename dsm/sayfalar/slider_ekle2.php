...
if(p('title') && g('islem')=="")
{
  ...
  if ($upload->uploaded){
    ...
    $upload->file_new_name_body = seo($ayar['firma_adi']).'-'.seo($title);
                                ...
                                <div class="box box-primary">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="link" value="<?php echo $SliderSonuc->link;?>" id="link" placeholder="https://www.siteadi.com/resim-linki" />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                ...
                                                <img src="../uploads/slider/<?php echo $SliderSonuc->image;?>" alt="" />
                                                <?php } else { ?>

...
if(p('page_name') && g('islem')=="")
{
  ...
  if ($upload2->uploaded){
    ...
    $upload2->process("../uploads/pages/webp");
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM sayfalar WHERE seo_link='$seo_link'"));
  if($sor->id != '')
  { 
    ...
    $sayfa_sorgu  = mysqli_query($conn,"INSERT INTO sayfalar SET
      page_name = '$page_name', en_page_name = '$en_page_name',

      page_description = '$page_description', en_page_description = '$en_page_description', 

      seo_title = '$seo_title', en_seo_title = '$en_seo_title', 
      
      seo_descriptions = '$seo_descriptions', en_seo_descriptions = '$en_seo_descriptions', 
      
      seo_link = '$seo_link', en_seo_link = '$en_seo_link',
...
if(p('page_name') && g('islem')=="duzenle")
{
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM sayfalar WHERE seo_link='$seo_link' AND id != '$d_id' "));

  if($sor->id > 0)
    {
      $bilgi = ' <div class="alert alert-danger alert-dismissable">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
      Aynı Kayıttan MevcutÜrün. Lütfen Farklı Bir Sayfa Adı Giriniz !
      </div> '; 
    } else {
      $resim_bul=mysqli_fetch_object(mysqli_query($conn,"SELECT * FROM sayfalar WHERE id='$d_id'"));
      $update_sql = "";
      if($sayfaresim){
          if(file_exists("../uploads/pages/".$resim_bul->page_image)){
           $resim_sil=unlink("../uploads/pages/".$resim_bul->page_image);   
          }
          $gitti=$sayfaresim=''.$upload->file_dst_name.'';
      ...
      if($page_image_webp!="")
      {
          if(file_exists("../uploads/pages/webp/".$resim_bul->page_image_web)){
              $resim_sil=unlink("../uploads/pages/webp/".$resim_bul->page_image_web);
          }
          $gitti2=$page_image_webp=''.$upload2->file_dst_name.'';
...
/* Genel Sıra */
$son_sira_sorgu = Sonuc(Sorgu("SELECT * FROM sayfalar ORDER BY `rank` DESC LIMIT 1"));
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Sayfa İçerikleri - Türkçe</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="page_name">Sayfa Adı *** (Zorunlu)</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="icerik">Sayfa Açıklaması</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/pages/<?php echo $SayfaSonuc->page_image;?>" alt="" />
                                                                    <?php } else { ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/pages/webp/<?php echo $SayfaSonuc->page_image_webp;?>" alt="" />
                                                                    <?php } else { ?>
                                                                    <img src="images/resimsec.jpg" alt="" />
                                                                    <?php }?>
                                                                    <?php } else { ?>
                            ...
                            <div class="tab-pane" id="<?=$Slider_LangSonuc2['id']?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Sayfa İçerikleri - <?=$Slider_LangSonuc2['name']?></h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="<?=$Slider_LangSonuc2['code']?>_page_name">Sayfa Adı</label>
                                                    <?php if ($code == "en"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->en_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Sayfa Adı" tabindex="1" /><?php endif ?>
                                                </div>

...
if(p('page_name') && g('islem')=="")
{
  ...
  $page_alt_cat = $_POST['page_alt_cat'];
  $anasayfa_status = $_POST['anasayfa_status'];
  ...
  if ($upload->uploaded){
    ...
    $upload->process("../uploads/product/");
    if ($upload->processed){
  ...
  if ($upload2->uploaded){
    ...
    $upload2->process("../uploads/product/webp");
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM urun WHERE seo_link='$seo_link'"));
  if($sor->id != '')
  { 
    $bilgi = ' <div class="alert alert-danger alert-dismissable">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    Aynı Kayıttan Mevcut. Lütfen Farklı Ürün Ekleyiniz !
    </div> '; 
  } 
  else { 
    $sayfa_sorgu  = Sorgu("INSERT INTO urun SET
      ...
      anasayfa_status = '$anasayfa_status',
...
if(p('page_name') && g('islem')=="duzenle")
{
  ...
  $gitti2=$page_image_webp=''.$upload2->file_dst_name.'';
  $sor = Sonuc(Sorgu("SELECT id FROM urun WHERE seo_link='$seo_link' AND id != '$d_id'"));

  if($sor->id != "")
    {
      $bilgi = ' <div class="alert alert-danger alert-dismissable">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
      Aynı Kayıttan MevcutÜrün. Lütfen Farklı Bir Ürün Adı Giriniz !
      </div> '; 
    } else {
      
      $resim_bul=Sonuc(Sorgu("SELECT * FROM urun WHERE id='$d_id'"));
      $update_sql = "";
      if($sayfaresim!="")
      {
          if(file_exists("../uploads/product/".$resim_bul->page_image)){
              $resim_sil=unlink("../uploads/product/".$resim_bul->page_image);
          }
      ...
      if($page_image_webp!="")
      {
          if(file_exists("../uploads/product/webp/".$resim_bul->page_image_web)){
              $resim_sil=unlink("../uploads/product/webp/".$resim_bul->page_image_web);
          }
      ...
      $sayfa_duzenle_sorgu  = Sorgu("UPDATE urun SET 
        page_name = '$page_name', en_page_name = '$en_page_name', de_page_name = '$de_page_name', ru_page_name = '$ru_page_name',
      fr_page_name = '$fr_page_name', es_page_name = '$es_page_name', it_page_name = '$it_page_name', ar_page_name = '$ar_page_name',
      ...
      if ($sayfa_duzenle_sorgu) {
        ...
        $bilgi = ' <div class="alert alert-danger alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        Ürün Güncellenmemiştir ! Lütfen Daha Sonra Tekrar Dene yiniz !
        </div> ';
      }
  }
}
...
if($_GET['islem']=="duzenle")
{
  ...
  $SayfaSonuc = Sonuc(Sorgu("SELECT * FROM urun WHERE id='$sayfaid'"));
}
/* Genel Sıra */
$son_sira_sorgu = Sonuc(Sorgu("SELECT * FROM urun ORDER BY `rank` DESC LIMIT 1"));
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small><i class="fa fa-edit"></i> Ürün Ekle</small>
        </h1>
        <ol class="breadcrumb">
                            ...
                            <div class="tab-pane active" id="1">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Ürün İçerikleri - Türkçe</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="page_name">Ürün Adı *** (Zorunlu)</label>
                                                    <input type="text" class="form-control page_name" name="page_name" value="<?php echo $SayfaSonuc->page_name;?>" id="page_name" placeholder="Ürün Adı" tabindex="1" autofocus required>
                                                </div>
                                                
                                                <div class="col-md-12"><hr></div><div class="clearfix"></div>

                                                <div class="form-group">
                                                    <label for="page_spot_description">Ürün Spot Açıklaması (Maks. 150 Karakter)</label>
                                                    <textarea id="icerik" name="page_spot_description" class="page_spot_description" placeholder="Ürün Spot Açıklaması" style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->page_spot_description;?></textarea>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                            ...
                                            <div class="box-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea id="icerik" name="seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->seo_descriptions;?></textarea>
                                                    </div>
                                                    <div class="box-footer">
                                                        <?php if($_GET['islem']=="duzenle"){?>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            ...
                                                            <select onchange="alt_kat_sec()" class="form-control" name="page_cat" id="page_cat" required>
                                                                <option value="0">Seçiniz</option>
                                                                <?php $AnaKategoriSorgu = Sorgu("SELECT * FROM urun_kategori WHERE statu = 1 ORDER BY `rank` ASC");
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/product/<?php echo $SayfaSonuc->page_image;?>" alt="" />
                                                                    <?php } else { ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/product/webp/<?php echo $SayfaSonuc->page_image_webp;?>" alt="" />
                                                                    <?php } else { ?>
                                                                    <img src="images/resimsec.jpg" alt="" />
                                                                    <?php }?>
                                                                    <?php } else { ?>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="square-green">
                                                                <div class="radio">
                                                                    <input tabindex="3" type="radio" value="1" <?php if($SayfaSonuc->anasayfa_status == '1') {?> checked <?php } ?> name="anasayfa_status">
                                                                    <div style="margin-left:30px;position:absolute;margin-top:-20px;">Aktif</div>
                                                                </div>
                                                            </div>
                                                            <div class="square-red">
                                                                <div class="radio">
                                                                    <input tabindex="3" type="radio" value="0" <?php if($SayfaSonuc->anasayfa_status == '0') {?> checked <?php } ?> name="anasayfa_status">
                                                                    <div style="margin-left:30px;position:absolute;margin-top:-20px;">Pasif</div>
                                                                </div>
                                                            </div>
                                                            <?php }else{?>
                                                            ...
                                                            <div class="square-green">
                                                                <div class="radio">
                                                                    <input tabindex="3" type="radio" value="1" checked name="anasayfa_status">
                                                                    <div style="margin-left:30px;position:absolute;margin-top:-20px;">Aktif</div>
                                                                </div>
                                                            </div>
                                                            <div class="square-red">
                                                                <div class="radio">
                                                                    <input tabindex="3" type="radio" value="0" name="anasayfa_status">
                                                                    <div style="margin-left:30px;position:absolute;margin-top:-20px;">Pasif</div>
                                                                </div>
                                                            </div>
                                                            <?php } ?>
                                        ...
                                        <div class="box box-danger box-solid collapsed-box" <?php if ($_GET['islem']==""): ?>style="display: none;"<?php endif ?>>
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Ürün Varyasyonları</h3>
                                                <div class="pull-right box-tools">
                                                    <button class="btn btn-info btn-sm" data-widget='collapse' data-toggle="tooltip" title="Aç / Kapat "> Aç / Kapat &nbsp&nbsp&nbsp&nbsp<i class="fa fa-plus"></i> </button>
                                                </div>
                                            </div>
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="form-group">
                                                          ...
                                                          <div class="form-group">
                                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                  <div class="fileupload-new thumbnail" style="width: 100%;">
                                                                      <a href="javascript:NewWindow=window.open('sayfalar/urun_resim_ekle.php?urun_id=<?=$SayfaSonuc->id;?>','newWin',width=' + popupWinWidth + ', height=' + popupWinHeight + ', top=' + top + ', left=' + left , toolbar=No,location=No,scrollbars=No,status=No,re sizable=No,fullscreen=No'); NewWindow.focus();void(0);">
                                                                          <img src="images/cokresimsec.jpg" alt="" />
                                                                      </a>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                      ...
                                                      <div class="col-md-4">
                                                          <label>Ürün Videoları</label>
                                                          <div class="form-group">
                                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                  <div class="fileupload-new thumbnail" style="width: 100%;">
                                                                      <a href="javascript:NewWindow=window.open('sayfalar/urun_video_ekle.php?urun_id=<?=$SayfaSonuc->id;?>','newWin',width=' + popupWinWidth + ', height=' + popupWinHeight + ', top=' + top + ', left=' + left , toolbar=No,location=No,scrollbars=No,status=No,re sizable=No,fullscreen=No'); NewWindow.focus();void(0);">
                                                      ...
                                                      <div class="col-md-4">
                                                          <label>Ürün Dosyaları</label>
                                                          <div class="form-group">
                                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                  <div class="fileupload-new thumbnail" style="width: 100%;">
                                                                      <a href="javascript:NewWindow=window.open('sayfalar/urun_dosya_ekle.php?urun_id=<?=$SayfaSonuc->id;?>','newWin',width=' + popupWinWidth + ', height=' + popupWinHeight + ', top=' + top + ', left=' + left , toolbar=No,location=No,scrollbars=No,status=No,re sizable=No,fullscreen=No'); NewWindow.focus();void(0);">
                                                                          <img src="images/dosyasec.jpg" alt="" />
                                                                      </a>
                                                                  </div>
                                                              </div>
                                                          </div>
                            ...
                            <div class="tab-pane" id="<?=$Slider_LangSonuc2['id']?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Ürün İçerikleri - <?=$Slider_LangSonuc2['name']?></h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="<?=$Slider_LangSonuc2['code']?>_page_name">Ürün Adı</label>
                                                    <?php if ($code == "en"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->en_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "de"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->de_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "ru"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->ru_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "fr"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->fr_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "es"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->es_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "it"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->it_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "ar"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->ar_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Ürün Adı" tabindex="1" /><?php endif ?>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="page_spot_description">Ürün Spot Açıklaması (Maks. 150 Karakter)</label>
                                                    <?php if ($code == "en"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->en_page_spot_description;?></textarea><?php endif ?>
                                                    <?php if ($code == "de"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->de_page_spot_description;?></textarea><?php endif ?>
                                                    <?php if ($code == "ru"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->ru_page_spot_description;?></textarea><?php endif ?>
                                                    <?php if ($code == "fr"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->fr_page_spot_description;?></textarea><?php endif ?>
                                                    <?php if ($code == "es"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->es_page_spot_description;?></textarea><?php endif ?>
                                                    <?php if ($code == "it"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->it_page_spot_description;?></textarea><?php endif ?>
                                                    <?php if ($code == "ar"): ?><textarea id="icerik" name="<?=$Slider_LangSonuc2['code']?>_page_spot_description" placeholder="Ürün Spot Açıklaması"  style="max-height: 130px; max-width: 100%; min-height: 130px; min-width: 100%;"><?php echo $SayfaSonuc->ar_page_spot_description;?></textarea><?php endif ?>
                                                </div>
                                        ...
                                        <div class="box box-success box-solid">
                                            ...
                                            <div class="box-body">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <label for="seo_descriptions">Sayfa Description (Açıklama) (Maks. 155 Karakter)</label>
                                                        <?php if ($code == "en"): ?><textarea id="icerik" name="en_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->en_seo_descriptions;?></textarea><?php endif ?>
                                                        <?php if ($code == "de"): ?>><textarea id="icerik" name="de_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->de_seo_descriptions;?></textarea><?php endif ?>
                                                        <?php if ($code == "ru"): ?>><textarea id="icerik" name="ru_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->ru_seo_descriptions;?></textarea><?php endif ?>
                                                        <?php if ($code == "fr"): ?>><textarea id="icerik" name="fr_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->fr_seo_descriptions;?></textarea><?php endif ?>
                                                        <?php if ($code == "es"): ?>><textarea id="icerik" name="es_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->es_seo_descriptions;?></textarea><?php endif ?>
                                                        <?php if ($code == "it"): ?>><textarea id="icerik" name="it_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->it_seo_descriptions;?></textarea><?php endif ?>
                                                        <?php if ($code == "ar"): ?>><textarea id="icerik" name="ar_seo_descriptions" placeholder="Sayfa Description" style="max-height: 150px; max-width: 100%; min-height: 150px; min-width: 100%;"><?php echo $SayfaSonuc->ar_seo_descriptions;?></textarea><?php endif ?>
                                                    </div>
                                                    <div class="box-footer">
                                                        <?php if($_GET['islem']=="duzenle"){?>
                                                        <button type="submit" onclick="submit();" class="btn btn-primary" style="float: right;margin-right: 5px;">Güncelle</button>
...
<script>
     function alt_kat_sec(){
        ana_kat_id = $("#page_cat").val();

        $.ajax({
        type: "POST",
        url: "sayfalar/alt_kat_getir.php",
        data: {
            ana_kat_id: ana_kat_id,
 ...
 success: function(data) {
    ...
    var selectAltKat = $('#page_alt_cat');
    selectAltKat.empty(); // Önceki alt kategori seçeneklerini temizleyin
     selectAltKat.append($('<option>', {
            value: 0,
            text: "Seçiniz"
        }));

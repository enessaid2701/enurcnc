...
if(p('page_name') && g('islem')=="")
{
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM urun_alt_kategori WHERE seo_link='$seo_link'"));
  if($sor->id != '')
  { 
    ...
    $sayfa_sorgu  = Sorgu("INSERT INTO urun_alt_kategori SET
      ...
      page_name = '$seo_title', en_page_name = '$en_seo_title',
...
if(p('page_name') && g('islem')=="duzenle")
{
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM urun_alt_kategori WHERE id='$d_id'"));
  if($sor->id == ""){
      $sor->id = $d_id;
  }
  if($sor->id != $d_id)
    {
      ...
      $resim_bul=Sonuc(Sorgu("SELECT * FROM urun_alt_kategori WHERE id='$d_id'"));
      $update_sql = "";
      if($sayfaresim!="")
      {
      ...
      $sayfa_duzenle_sorgu  = Sorgu("UPDATE urun_alt_kategori SET 
      page_description = '$page_description', en_page_description = '$en_page_description',
...
if($_GET['islem']=="duzenle")
{
  ...
  $SayfaSonuc = Sonuc(Sorgu("SELECT * FROM urun_alt_kategori WHERE id='$sayfaid'"));
}
/* Genel Sıra */
$son_sira_sorgu = Sonuc(Sorgu("SELECT * FROM urun_alt_kategori ORDER BY `rank` DESC LIMIT 1"));
                            ...
                            <div class="tab-pane active" id="1">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="box box-danger box-solid <?php if ($_GET['duzenle']==""): ?>collapsed-box<?php endif ?>" <?php if ($_GET['islem']==""): ?>style="display: none;"<?php endif ?>>
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Kategori Varyasyonları</h3>
                                                <div class="pull-right box-tools">
                                                    <button class="btn btn-info btn-sm" data-widget='collapse' data-toggle="tooltip" title="Aç / Kapat "> Aç / Kapat &nbsp&nbsp&nbsp&nbsp<i class="fa fa-plus"></i> </button>
                                                </div>
                                            </div>
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="form-group">
                                                      <div class="col-md-6">
                                                          <label>Kategori Sektör Bağlılığı</label>
                                                          <div class="form-group">
                                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                  <div class="fileupload-new thumbnail" style="width: 100%;">
                                                                      <a href="javascript:NewWindow=window.open('sayfalar/urun_kategori_sektor_ekle.php?urun_kategori_id=<?=$SayfaSonuc->id;?>','newWin',width=' + popupWinWidth + ', height=' + popupWinHeight + ', top=' + top + ', left=' + left , toolbar=No,location=No,scrollbars=No,status=No,re sizable=No,fullscreen=No'); NewWindow.focus();void(0);">
                                                                          <img src="images/urunsec.jpg" alt="" />
                                                                      </a>
                                                                  </div>
                                                              </div>
                                                          </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            ...
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="<?=$Slider_LangSonuc2['code']?>_seo_title">Kategori Adı</label>

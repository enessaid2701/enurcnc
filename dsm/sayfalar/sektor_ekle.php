...
if(p('page_name') && g('islem')=="")
{
  ...
  $uploadDir = '../uploads/sector/video/';
  $videoFile = $uploadDir . basename($_FILES['page_image_webp']['name']);
  $videoFileType = pathinfo($videoFile, PATHINFO_EXTENSION);

  $seoLink = urlencode(basename($seo_link, "." . $videoFileType));
    $newVideoFileName = $seoLink . '.' . $videoFileType;

    move_uploaded_file($_FILES['page_image_webp']['tmp_name'], $uploadDir . $newVideoFileName);
        // Video başarıyla yüklendi, veritabanına kaydedin
        // $videoTitle = $_FILES['video']['name'];

        $uploadDirDikey = '../uploads/sector/dikey/';
        $dikeyGorsel = $uploadDirDikey . basename($_FILES['dikey_gorsel']['name']);
        $dikeyGorselType = pathinfo($dikeyGorsel, PATHINFO_EXTENSION);
      
        $seoLink2 = urlencode(basename($seo_link, "." . $dikeyGorselType));
          $newdikeyGorselName = $seoLink2 . '.' . $dikeyGorselType;
      
          move_uploaded_file($_FILES['dikey_gorsel']['tmp_name'], $uploadDirDikey . $newdikeyGorselName);

          $gorseller = '';
          if($sayfaresim != ''){
            $gorseller .= "page_image   = '$sayfaresim', ";
          }if($newVideoFileName != ''){
            $gorseller .= "page_image_webp   = '$newVideoFileName',";

          }if($newdikeyGorselName != ''){
              
            $gorseller .= "dikey_gorsel   = '$newdikeyGorselName',";
          }
  
  $sor = Sonuc(Sorgu("SELECT id FROM sektor WHERE seo_link='$seo_link'"));
  if($sor->id != '')
  { 
    $bilgi = ' <div class="alert alert-danger alert-dismissable">
    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
    Aynı Kayıttan Mevcut. Lütfen Farklı Sayfa Ekleyiniz !
    </div> '; 
  } 
  else { 
    $sayfa_sorgu  = Sorgu("INSERT INTO sektor SET
...
if(p('page_name') && g('islem')=="duzenle")
{
  ...
  $seoLink = urlencode(basename($seo_link, "." . $videoFileType));
    ...
    $seoLink2 = urlencode(basename($seo_link, "." . $dikeyGorselType));
      ...
      $sayfa_id = $_GET['id'];
      $resim_bul=Sonuc(Sorgu("SELECT * FROM sektor WHERE id='$sayfa_id'"));

      
      $sayfa_duzenle_sorgu  = Sorgu("UPDATE sektor SET 
        page_name = '$page_name', en_page_name = '$en_page_name', de_page_name = '$de_page_name', ru_page_name = '$ru_page_name',
      fr_page_name = '$fr_page_name', es_page_name = '$es_page_name', it_page_name = '$it_page_name', ar_page_name = '$ar_page_name',
      ...
      fr_seo_link = '$fr_seo_link', es_seo_link = '$es_seo_link', it_seo_link = '$it_seo_link', ar_seo_link = '$en_seo_link',
        ...
        $bilgi = ' <div class="alert alert-danger alert-dismissable">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
        Sayfa ile Güncellenmemiştir ! Lütfen Daha Sonra Tekrar Dene yiniz !
        </div> ';
      }
...
if($_GET['islem']=="duzenle")
{
  ...
  $SayfaSonuc = Sonuc(Sorgu("SELECT * FROM sektor WHERE id='$sayfaid'"));
}
/* Genel Sıra */
$son_sira_sorgu = Sonuc(Sorgu("SELECT * FROM sektor ORDER BY `rank` DESC LIMIT 1"));
                                        ...
                                        <div class="box box-primary box-solid">
                                            ...
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    ...
                                                    <input type="text" class="form-control page_name" name="page_name" value="<?php echo $SayfaSonuc->page_name;?>" id="page_name" placeholder="Sayfa Adı" tabindex="1" autofocus required>
                                                </div>
                                            ...
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/sector/<?php echo $SayfaSonuc->page_image;?>" alt="" />
                                                                    <?php } else { ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label>Breadcump Video</label>
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    <?php if($_GET['islem']=='duzenle'){?>
                                                                    <?php if($SayfaSonuc->page_image_webp){?>
                                                                    <img src="../uploads/sector/webp/<?php echo $SayfaSonuc->page_image_webp;?>" alt="" />
                                                                    <?php } else { ?>
                                                                    <img src="images/resimsec.jpg" alt="" />
                                                                    <?php }?>
                                                                    <?php } else { ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            <label>Anasayfa Dikey Görsel</label>
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    <?php if($_GET['islem']=='duzenle'){?>
                                                                    <?php if($SayfaSonuc->dikey_gorsel){?>
                                                                    <img src="../uploads/sector/dikey/<?php echo $SayfaSonuc->dikey_gorsel;?>" alt="" />
                                                                    <?php } else { ?>
                                                                    <img src="images/resimsec.jpg" alt="" />
                                                                    <?php }?>
                                                                    <?php } else { ?>
                                                                ...
                                                                <div>
                                                                    <span class="btn btn-default btn-file">
                                                                        <span class="fileupload-new"><i class="fa fa-paper-clip"></i> Görsel Seç</span>
                                                                        <span class="fileupload-exists"><i class="fa fa-undo"></i> Değiştir</span>
                                                                        <input name="dikey_gorsel" type="file" class="default" />
                                                                    </span>
                                                                    <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload"><i class="fa fa-trash"></i> Sil</a>
                                                                </div>
                                                            </div>

...
if(p('page_name') && g('islem')=="")
{
  ...
  $ru_seo_descriptions = $_POST['en_page_description'];
  ...
  $de_seo_link = $_POST['de_seo_link'];
  $ru_seo_link = $_POST['en_seo_link'];
  $fr_seo_link = $_POST['fr_seo_link'];
  $es_seo_link = $_POST['es_seo_link'];
  $it_seo_link = $_POST['it_seo_link'];
  ...
  if ($upload->uploaded){
    ...
    $upload->process("../uploads/new_cat");
    if ($upload->processed){
  ...
  if ($upload2->uploaded){
    ...
    $upload2->process("../uploads/new_cat/webp");
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM haber_kategori WHERE seo_link='$seo_link'"));
  if($sor->id != '')
  { 
    ...
    $sayfa_sorgu  = Sorgu("INSERT INTO haber_kategori SET
...
if(p('page_name') && g('islem')=="duzenle")
{
  ...
  $sor = Sonuc(Sorgu("SELECT id FROM haber_kategori WHERE seo_link='$seo_link' AND id != '$d_id'"));

  if($sor->id > 0)
    {
      $bilgi = ' <div class="alert alert-danger alert-dismissable">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
      Aynı Kayıttan MevcutÜrün. Lütfen Farklı Bir Medya Kategori Adı Giriniz !
      </div> '; 
    } else {
        $update_sql = "";
        $resim_bul=Sonuc(Sorgu("SELECT * FROM haber_kategori WHERE id='$d_id'"));
      
          if($sayfaresim != "")
            {
             if(file_exists("../uploads/new_cat/".$resim_bul->page_image)){
                 $resim_sil=unlink("../uploads/new_cat/".$resim_bul->page_image);
             }
              $gitti=$sayfaresim=''.$upload->file_dst_name.'';
            ...
            if($page_image_webp != "")
            {
             if(file_exists("../uploads/new_cat/webp/".$resim_bul->page_image_web)){
                 $resim_sil=unlink("../uploads/new_cat/webp/".$resim_bul->page_image_web);
             }
              $gitti2=$page_image_webp=''.$upload2->file_dst_name.'';
              $update_sql .= "page_image_web = '$page_image_webp', ";
            }
        
        $sayfa_duzenle_sorgu  = Sorgu("UPDATE haber_kategori SET 
          page_name = '$page_name', en_page_name = '$en_page_name', de_page_name = '$de_page_name', ru_page_name = '$ru_page_name',
          fr_page_name = '$fr_page_name', es_page_name = '$es_page_name', it_page_name = '$it_page_name', ar_page_name = '$ar_page_name',
...
if($_GET['islem']=="duzenle")
{
  ...
  $SayfaSonuc = Sonuc(Sorgu("SELECT * FROM haber_kategori WHERE id='$sayfaid'"));
}
/* Genel Sıra */
$son_sira_sorgu = Sonuc(Sorgu("SELECT * FROM haber_kategori ORDER BY `rank` DESC LIMIT 1"));
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small><i class="fa fa-edit"></i> Medya Kategori Ekle</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Anasayfa</a></li>
            <li class="active">Medya Kategori Ekle</li>
        </ol>
    </section>
    <!-- Main content -->
                                    ...
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Medya Kategori İçerikleri - Türkçe</h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="page_name">Medya Kategori Adı *** (Zorunlu)</label>
                                                    <input type="text" class="form-control page_name" name="page_name" value="<?php echo $SayfaSonuc->page_name;?>" id="page_name" placeholder="Medya Kategori Adı" tabindex="1" autofocus required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="icerik">Medya Medya Kategori Açıklaması</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/new_cat/<?php echo $SayfaSonuc->page_image;?>" alt="" />
                                                                    <?php } else { ?>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                                    ...
                                                                    <img src="../uploads/new_cat/webp/<?php echo $SayfaSonuc->page_image_webp;?>" alt="" />
                                                                    <?php } else { ?>
                                                                    <img src="images/resimsec.jpg" alt="" />
                                                                    <?php }?>
                                                                    <?php } else { ?>
                            ...
                            <div class="tab-pane" id="<?=$Slider_LangSonuc2['id']?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-primary box-solid">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">Medya Kategori İçerikleri - <?=$Slider_LangSonuc2['name']?></h3>
                                            </div>
                                            <div class="box-body">
                                                <div class="form-group has-error">
                                                    <label for="<?=$Slider_LangSonuc2['code']?>_page_name">Medya Kategori Adı</label>
                                                    <?php if ($code == "en"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->en_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "de"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->de_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "ru"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->ru_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "fr"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->fr_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "es"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->es_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "it"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->it_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                    <?php if ($code == "ar"): ?><input type="text" class="form-control <?=$Slider_LangSonuc2['code']?>_page_name" name="<?=$Slider_LangSonuc2['code']?>_page_name" value="<?php echo $SayfaSonuc->ar_page_name;?>" id="<?=$Slider_LangSonuc2['code']?>_page_name" placeholder="Medya Kategori Adı" tabindex="1" /><?php endif ?>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="icerik">Medya Kategori Açıklaması</label>

...
if(g('islem')=="sil")
{
  ...
  $resim_sil2=unlink("../uploads/pages/webp/".$resim_bul->page_image_webp);
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header" style="padding:0;">
            <a href="kurumsal-sayfa-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Sayfa Ekle</a>
          </div><!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-hover">
              <thead>
                <tr>
                  <th>Sıra</th>
                  <th>Sayfa Adı (TR)</th>
                  <th>Sayfa Linki (TR)</th>
                  <th style="width:100px;">Durumu</th>
                  <th style="width:100px;">İşlem</th>
                </tr>
              </thead>
              <tbody>
                <?php $SayfaSorgu = Sorgu("SELECT * FROM sayfalar ORDER BY `rank` DESC");
                while($SayfaSonuc = Sonuc($SayfaSorgu)){?>
                  <tr>
                   ...
                   <td>
                    <?php if ($SayfaSonuc->id != 1 && $SayfaSonuc->id != 2 && $SayfaSonuc->id != 3 && $SayfaSonuc->id != 4 && $SayfaSonuc->id != 5 && $SayfaSonuc->id != 6 && $SayfaSonuc->id != 7 && $SayfaSonuc->id != 8): ?>
                    ...
                    <?php endif ?>
                    <a href="?sayfa=kurumsal-sayfa-ekle&islem=duzenle&id=<?php echo $SayfaSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
                      Düzenle
                    </a>
                  </td>
                </tr>

...
if(p('kadi') && g('islem')=="")
{
	...
	$email 		= p('email');
	$kadi 		= p('kadi');
	$yonetici_yetki 		= p('yonetici_yetki');
	$sifre 		= p('sifre');
	$t			= date("Y-m-d H:i:s");
	$tarih		= tarih($t);
            ...
            <form method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="sifre" value="<?php echo $Yonetici->yonetici_sifre;?>" id="sifre" placeholder="Şifre">
                </div>

                <div class="form-group">
                  <label for="yetki">Kullanıcı Rolü</label>
                  <select name="yonetici_yetki" id="yetki" class="form-control">
                    <option value="1" selected>Tümü</option>
                    <option value="2" <?=($Yonetici->yonetici_sifre == 2)?"selected":""?>>Muhasebe</option>
                  </select>
                </div>

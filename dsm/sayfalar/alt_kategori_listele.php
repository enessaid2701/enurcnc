...
{
  $id = g('id');
  $resim_bul=Sonuc(Sorgu("SELECT * FROM urun_alt_kategori WHERE id='$id'"));
  $resim_sil=unlink("../uploads/product_cat/".$resim_bul->page_image);
  $resim_sil2=unlink("../uploads/product_cat/webp/".$resim_bul->page_image_webp);
  
  $kategori_sil_sorgu = Sorgu("DELETE FROM urun_alt_kategori WHERE id='$id'");
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header" style="padding:0;">
                        <a href="alt-kategori-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Kategori Ekle</a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $SayfaSorgu = Sorgu("SELECT * FROM urun_alt_kategori ORDER BY `rank` DESC");
                                while($SayfaSonuc = Sonuc($SayfaSorgu)){?>
                                <tr>
                                    <td><?php echo $SayfaSonuc->rank; ?></td>
                                    <td><?php echo $SayfaSonuc->seo_title; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <?php }else{?>
                                        <a class="btn btn-success btn-xs" href="../uploads/product_cat/<?php echo $SayfaSonuc->page_image; ?>" target="_blank"><i class="fa fa-eye"></i> Resmi Gör</a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="?sayfa=alt-kategori-ekle&islem=duzenle&id=<?php echo $SayfaSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
                                            Düzenle
                                        </a>
                                    </td>
                                </tr>

      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header" style="padding:0;">
            <a href="slider-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Resim Ekle</a>
          </div><!-- /.box-header -->
          <div class="box-body">
            <table id="example1" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                while($SliderSonuc = Sonuc($SliderSorgu)){?>
                  <tr>
                    <td><?php echo $SliderSonuc->rank; ?></td>
                    <td><?php echo $SliderSonuc->title; ?> <?php echo $SliderSonuc->title2; ?></td>
                        <!--<td>
                          <?php if($SliderSonuc->link == "" ){?>
                            <span class="btn btn-danger btn-xs"><i class="fa fa-picture-o"></i> Resim Linki Yok</span>
                          <?php }else{?>
                            <a class="btn btn-success btn-xs" href="<?php echo $SliderSonuc->link; ?>" target="_blank"><i class="fa fa-eye"></i> Resim Linki Gör</a>
                          <?php } ?>
                        </td>-->
                        <td>
                          ...
                          <?php }else{?>
                            <a class="btn btn-success btn-xs" href="../<?php echo $SliderSonuc->image; ?>" target="_blank"><i class="fa fa-eye"></i> Resmi Gör</a>
                          <?php } ?>
                        </td>
                        <td>
                          <?php
                          if($SliderSonuc->statu=='1'){?>

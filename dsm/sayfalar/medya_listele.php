...
{
  $id = g('id');
  $resim_bul=Sonuc(Sorgu("SELECT * FROM haber WHERE id='$id'"));
  $resim_sil=unlink("../uploads/news/".$resim_bul->page_image);
  $resim_sil2=unlink("../uploads/news/webp/".$resim_bul->page_image_webp);
  
  $kategori_sil_sorgu = Sorgu("DELETE FROM haber WHERE id='$id'");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <small><i class="fa fa-tasks"></i> Sektör Listesi</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header" style="padding:0;">
                        <a href="medya-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Sektör Ekle</a>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $SayfaSorgu = Sorgu("SELECT * FROM haber ORDER BY `rank` DESC");
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php }else{?>
                                        <a class="btn btn-success btn-xs" href="../uploads/news/<?php echo $SayfaSonuc->page_image; ?>" target="_blank"><i class="fa fa-eye"></i> Resmi Gör</a>
                                        <?php } ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="?sayfa=medya-ekle&islem=duzenle&id=<?php echo $SayfaSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
                                            Düzenle
                                        </a>
                                    </td>
                                </tr>
